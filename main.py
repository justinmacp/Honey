...
dependent_words, expected_value, standard_deviation, probability_given_5, probability_given_4, probability_given_3, probability_given_2, probability_given_1 = wordbias(wordcount1,wordcount2,wordcount3,wordcount4,wordcount5,'dict.json')
'''
    testing on data.txt using dict.json; results placed in dataout.json
'''
sentence_filter('data.txt','dataout.json','dict.json')
